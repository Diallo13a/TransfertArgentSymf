 ...
 */
final class Version20210227232603 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction ADD client_retrait_id INT DEFAULT NULL, CHANGE client_id client_depot_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction ADD client_id INT DEFAULT NULL, DROP client_depot_id, DROP client_retrait_id');
